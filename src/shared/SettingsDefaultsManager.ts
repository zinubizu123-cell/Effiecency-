...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_OPENROUTER_BASE_URL: string;  // Base URL for OpenRouter-compatible API (supports local servers)
...
export class SettingsDefaultsManager {
  ...
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_OPENROUTER_BASE_URL: 'https://openrouter.ai/api/v1/chat/completions',  // Override for local/compatible servers (e.g. llama.cpp)
